...
import 'package:dlaundry_mobile/pages/detail_laundry_page.dart';
            ...
            return Padding(
              ...
              child: InkWell(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      color: category == categorySelected ? Colors.green : Colors.grey[400]!,
                    ),
                    color: category == categorySelected ? Colors.green : Colors.transparent,
                    borderRadius: BorderRadius.circular(30),
                  ),
